...
namespace UnityExplorer.Hooks
{
    public class HookInstance
    {
        ...
        public bool CustomPatch(MethodInfo targetInfo)
        {
            ExplorerCore.Log("Trying to Patch Method");
            var harmony = new HarmonyLib.Harmony("com.unityexplorer.customhook");
            harmony.Patch(targetInfo, null,
                new HarmonyMethod(typeof(HookInstance).GetMethod("Postfix", BindingFlags.Public | BindingFlags.Static)));
            ExplorerCore.Log("Patched Method");
            //ExplorerCore.Harmony.UnpatchSelf();
            
            //ExplorerCore.Harmony.Patch()
        ...
        {
            ExplorerCore.Log("Hooked Method was Called");
        }
