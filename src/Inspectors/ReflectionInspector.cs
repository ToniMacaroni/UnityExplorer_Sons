...
namespace UnityExplorer.Inspectors
{
    ...
    public class ReflectionInspector : InspectorBase, ICellPoolDataSource<CacheMemberCell>, ICacheObjectController
    {
        ...
        MemberFilter memberFilter = MemberFilter.Property | MemberFilter.Method;
        ...
        MemberFilter lastMemberFilter = MemberFilter.Property | MemberFilter.Method;
        ...
        void FilterMembers()
        {
            ...
            for (int i = 0; i < members.Count; i++)
            {
                ...
                if (member.NameForFiltering.ToLower().StartsWith("object.")
                    || member.NameForFiltering.StartsWith("Component.")
                    || member.NameForFiltering.StartsWith("Behaviour.")
                    || member.NameForFiltering.StartsWith("MonoBehaviour.")
                    || member.NameForFiltering.StartsWith("Transform.") 
                    || member.NameForFiltering.ToLower().StartsWith("il2cpp"))
                    continue;
