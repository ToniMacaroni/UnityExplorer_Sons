...
namespace UnityExplorer.UI.Panels
{
    public class ClipboardPanel : UEPanel
    {
        ...
        private static void DumpObject()
        {
            ...
            UERuntimeHelper.DumpComponentData(Current);
        }
        ...
        protected override void ConstructPanelContent()
        {
            ...
            UniverseLib.UI.Models.ButtonRef exportButton = UIFactory.CreateButton(currentPasteHolder, "ExportButton", "E");
            UIFactory.SetLayoutElement(exportButton.Component.gameObject, minHeight: 25, flexibleHeight: 0, minWidth: 30, flexibleWidth: 0);
            exportButton.OnClick += DumpObject;
        }
    }
}
